...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/replace-the-bit3212/1)

## Solved On
10 Sept 2026 at 06:04 am

<h2><a href="https://www.geeksforgeeks.org/problems/replace-the-bit3212/1">Unset Kth Bit</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 14pt;"><span style="font-family: arial, helvetica, sans-serif;">Given two numbers<strong> n</strong> and <strong>k</strong>, change the <strong>kth </strong>bit (1-based indexing, counted from the left) of <strong>n's</strong> binary representation to <strong>0</strong> if it is currently <strong>1</strong>. </span></span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:<br></strong>1 ≤ n ≤ 10<sup>6</sup><br>1 ≤ k ≤ 20</span></p>